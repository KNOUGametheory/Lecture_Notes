...
<!-- 편미분계수
 ...
 𝑔^′ (𝑎)=lim┬(ℎ \rightarrow 0)  (𝑔(𝑎 + ℎ)−𝑔(𝑎))/ℎ  (𝑎,𝑏)에서 𝑓의 𝑥에 대한 편미분계수
편미분계수의 표현: 𝑓_𝑥 (𝑎,𝑏); 𝜕𝑓/𝜕𝑥 (𝑎,𝑏); ├ 𝜕𝑧/𝜕𝑥┤|_((𝑥,𝑦)=(𝑎,𝑏) )
    ※ 𝜕: 라운드 𝑑

 𝑧=𝑓(𝑥,𝑦)에 대하여 𝑥=𝑎이고 𝑦만 변화할 때
 𝑘(𝑦)=𝑓(𝑎, 𝑦)일 때, 𝑘(𝑦)가 𝑦=𝑏에서 미분가능
 𝑘^′ (𝑏)=lim┬(ℎ \rightarrow 0)  (𝑘(𝑏 + ℎ)−𝑘(𝑏))/ℎ  (𝑎,𝑏)에서 𝑓의 𝑦에 대한 편미분계수
편미분계수의 표현: 𝑓_𝑦 (𝑎,𝑏); 𝜕𝑓/𝜕y (𝑎,𝑏);├ 𝜕𝑧/𝜕𝑦┤|_((𝑥,𝑦)=(𝑎,𝑏) )
    ※ 𝜕: 라운드 𝑑

편도함수(partial derivative)
 𝑧=𝑓(𝑥,𝑦)에 대하여 𝑓의 𝑥에 대한 편도함수:𝑓_𝑥 (𝑥,𝑦)=𝜕𝑓/𝜕𝑥 (𝑥,𝑦)=lim┬(ℎ \rightarrow 0)  (𝑓(𝑥 + ℎ, 𝑦)−𝑓(𝑥,𝑦))/ℎ
 𝑧=𝑓(𝑥,𝑦)에 대하여 𝑓의 𝑦에 대한 편도함수: 𝑓_𝑦 (𝑥,𝑦)=𝜕𝑓/𝜕𝑦 (𝑥,𝑦)=lim┬(ℎ \rightarrow 0)  (𝑓(𝑥, 𝑦 + ℎ)−𝑓(𝑥,𝑦))/ℎ
