...
- 최고가밀봉경매 판매자의 기대수익
	...
	- 한 사람은 저평가 구매자이고 나머지 한 사람은 고평가 구매자일 경우
		...
		- 경매자의 기대수익은 고평가 구매자가 적어 내는 입찰가와 동일
		
		- $${2 \choose 1}(\frac{1}{2})^{1}(\frac{1}{2})^{1}$$
		
	- 둘 모두 고평가 구매자일 경우 낙찰가격은 두 사람이 적어 내는 입찰가격 중 큰 값

		- $${2 \choose 2}(\frac{1}{2})^{2}(\frac{1}{2})^{0}$$
