...
* 열등전략  Dominated Strategy
  ...
  * 강열등전략(strongly dominated strategy)
	...
	경기자 2의 임의의 전략 $$s_{1}$$에 대하여, $$u_{1}(s_{1}^{ ̂},s_{2} < u_{1}(s_{1}^{′},s_{2})$$를 만족하는 경기자 1의 전략 $$s_{1}^{′}$$이 존재할 때 경기자 1의 전략 $$s_{1}^{ ̂}$$

  * 약열등전략(weakly dominated strategy)

	경기자 2의 임의의 전략 $$s_{1}$$에 대하여, $$u_{1}(s_{1}^{ ̂},s_{2} \seq u_{1}(s_{1}^{′},s_{2})$$를 만족하는 경기자 1의 전략 $$s_{1}^{′}$$이 존재할 때 경기자 1의 전략 $$s_{1}^{ ̂}$$
