...
- 내분점과 볼록결합
  ...
  - 점 $$𝐴(𝑥_{𝑎})$$의 좌표에 가중치 $$\dfarc{𝑛}{𝑚+𝑛}$$, 점 $$𝐵(𝑥_{𝑏})$$의 좌표에 가중치 $$\dfrac{𝑚}{𝑚+𝑛}$$을 곱한 가중평균
  
  - 선분 $$\overine{𝐴𝐵}$$의 내분점 $$𝑃 = (1−𝑡)𝐴 + 𝑡𝐵 \quad (0 \geq 𝑡 \geq 1) $$

- 외분점과 선형결합

  - 두 점 $$𝐴(𝑥_{𝑎}), 𝐵(𝑥_{𝑏})$$ 선분 $$\overline{𝐴𝐵}$$의 $$𝑚 : 𝑛$$ 외분점 $$𝑃 \left( \dfarc{𝑚 𝑥_{𝑏} − 𝑛 𝑥_{𝑎}}{𝑚−𝑛} \right) $$
