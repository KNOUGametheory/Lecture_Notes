...
- 예제 1: $$3𝑛+2$$가 홀수이면 $$𝑛$$은 홀수이다?
  ...
  - 전제 ‘$$3𝑛+2$$가 홀수’에서 출발하면?
    ...
    - 이항하여 $$3𝑛+1=2𝑘$$를 이용하려면? 경우 나누기? (how?)
...
- 모순(contradiction)을 이용한 증명
  ...
  - 조건문 $$\neg p \rightarrow p$$가 ‘참’이고 모순 $$𝑞$$가 ‘거짓’이면
...
- 예제 1: $$\sqrt{2}$$는 무리수이다?
  ...
  - $$\sqrt{2}$$가 유리수라고 가정 $$\sqrt{2}= b / a$$인 서로소인 정수 $$ a \neq 0, b $$가 존재
  
  - $$\sqrt{2} = b / a \rightarrow b = \sqrt{2}a \rightarrow$$ 양변을 제곱하면 $$𝑏^{2}=2𝑎^{2}$$ ... (이하 생략) ...
...
- 예제 2: $$3𝑛+2$$가 홀수이면 $$𝑛$$은 홀수이다?
  ...
  - $$\rightarrow 3𝑛+2 = 3(2𝑘)+2 = 2(3𝑘+1)$$이므로 짝수 $$3𝑛+2$$가 홀수이고 동시에 $$3𝑛+2$$가 짝수? 
