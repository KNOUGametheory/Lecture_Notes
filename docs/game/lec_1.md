...
-   게임 이론의 출발점
    ...
    > "이 책의 목적은 지금까지 문헌에서 찾을 수 있는 것과는 다른 처리를 필요로 하는 경제 이론의 근본적인 질문에 관한 논의를 제시하는 것이다. ... "로빈슨 크루소\" 모형으로 대표되는 형태의 경제, 하나의 의지를 가진 고립되어 있는 단일한 개인 또는 조직의 경제 ... 사회적 교환 경제의 참여자, ... 극대화 문제와 많은 요소에서 유사성이 있지만, ... 이를 달성하기 위해서는 다른 사람과의 교환 관계에 참여해야만 한다 {% cite Neumann:2007aa %}.\"
