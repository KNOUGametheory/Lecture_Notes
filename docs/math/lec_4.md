...
-  $$ 𝑧 = 𝑓(𝑥,𝑦)$$에 대하여 $$𝑥 = 𝑎$$ 이고 $$𝑦$$ 만 변화할 때
 ...
 - 편미분계수의 표현: $$𝑓_{𝑦} (𝑎,𝑏); \dfarc{\partial 𝑓}{\partial y} (𝑎,𝑏); \dfarc{\partial 𝑧}{\partial 𝑦} \vert_{(𝑥,𝑦)=(𝑎,𝑏) }$$
...
- 편도함수(partial derivative)
  ...
  - $$ 𝑧 = 𝑓(𝑥,𝑦)$$에 대하여 $$𝑓$$의 $$𝑦$$에 대한 편도함수:
    ...
    $$
    𝑓_{𝑦} (𝑥,𝑦) = \dfarc{\partial 𝑓}{\partial 𝑦} (𝑥,𝑦) = \lim_{ℎ \rightarrow 0} \dfrac{𝑓(𝑥, 𝑦 + ℎ)−𝑓(𝑥,𝑦)}{ℎ}
    $$
...
- 편도함수와 일차근사(linear approximation)
  ...
  - $$𝑧 = 𝑓(𝑥, 𝑦) = 5−𝑥^{2}−2𝑦^{2}$$에 대하여 $$𝑓(1.1, 0.9)$$의 근삿값을 $$(1, 1)$$의 일차근사를 이용하여 계산
    ...
    𝑓_{𝑥} & = \dfrc{\partial 𝑓}{\partial 𝑥} = −2𝑥 \rightarrow 𝑓_{𝑥}(1, 1) = −2 \\
