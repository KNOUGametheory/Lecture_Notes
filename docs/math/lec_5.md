...
$$
\begin{array}{cccc}
&p(1)=\dfrac{_{3}C_{1}}{2^{3}}=\dfrac{3}{8}&p(2)=\dfrac{_{3}C_{2}}{2^{3}}=\dfrac{3}{8}&\\
p(0)=\dfrac{_{3}C_{0}}{2^{3}}=\dfrac{1}{8}&&&p(3)=\dfrac{_{3}C_{3}}{2^{3}}=\dfrac{1}{8}\\
\end{array}
$$
...
$$
\begin{array}{ccccc}
&&p(2)=\dfrac{_{4}C_{2}}{2^{4}}=\dfrac{6}{16}&&\\
&p(1)=\dfrac{_{4}C_{1}}{2^{4}}=\dfrac{4}{16}&&p(3)=\dfrac{_{4}C_{3}}{2^{4}}=\dfrac{4}{16}&\\
p(5)=\dfrac{_{4}C_{0}}{2^{4}}=\dfrac{1}{16}&&&&p(4)=\dfrac{_{4}C_{4}}{2^{4}}=\dfrac{1}{16}\\
\end{array}
$$
