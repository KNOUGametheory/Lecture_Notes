...
- 기울기 벡터 예제
  ...
  - $$z = 𝑓(𝑥,𝑦) = 𝑥^{2} 𝑦 + 6𝑥𝑦^{3} $$ @ $$ 𝑃 = (1,2)$$ 기울기 벡터는?
	...
	\begin{align}
       ...
       𝑓_{𝑦} &= \dfarc{\partial 𝑓}{\partial 𝑦} = 𝑥^{2} + 18𝑥𝑦^{2} \\
        \end{align}
    $$
...
- 기울기 벡터와 등위선의 증가/감소 예제
  ...
  - $$𝑧 = 𝑓(𝑥, 𝑦) = 5−𝑥^{2} − 2𝑦^{2}$$ 위의 점 $$(1, 1)$$에 $$𝑓$$가 가장 빠르게 증가하는/감소하는 방향은?
    ...
    $$
	\begin{align}
	𝑓_{𝑥} = \dfarc{\partial 𝑓}{\partial 𝑥} = −2𝑥 \rightarrow 𝑓_{𝑥} (1, 1) = −2 \\
	𝑓_{𝑦} = \dfarc{\partial 𝑓}{\partial 𝑦} = −4𝑦 \rightarrow 𝑓_{𝑦} (1, 1) = −4 \\
	\end{align}
    $$
