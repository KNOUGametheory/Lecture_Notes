...
-   전략에 따라 속성 만들기
    ...
    -   `Retaliating`: 상대방의 배신 이후 배신하는 경기자의 비율, 상대방의 협력 이후 배신하는 경기자의 비율 $$\rightarrow$$ 두 비율 간의 차이

    -   `Forgiving`: 상대방의 DC 이후 협력하는 경기자의 비율, 상대방의 CD 이후 협력하는 경기자의 비율 $$\rightarrow$$ 둘의 차이

    -   `Forgiving2`: 상대방의 첫 두 게임에 대해 협력하는 경기자의 비율
